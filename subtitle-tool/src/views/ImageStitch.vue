  ...
  <div class="stitch-layout">
    ...
    <div class="stitch-right">
      ...
      <div class="settings-panel">
        ...
        <!-- 间距滑块 -->
        <SliderInput v-model="gap"    label="图片间距" unit="px" :min="0" :max="100" />
        <!-- 圆角滑块 -->
        <SliderInput v-model="radius" label="圆角大小" unit="px" :min="0" :max="80"  />
        ...
        <div class="setting-row">
          ...
          <div class="color-swatches">
            ...
            >
              <!-- 透明色显示斜线图标 -->
              <i v-if="color.value === 'transparent'" class="fa-solid fa-ban" style="font-size:0.7rem; color:var(--muted)"></i>
            </button>
          </div>
        </div>
        ...
        >
          ...
          {{ images.length < 2 ? '至少需要 2 张图片' : '导出拼接图' }}
        </button>
...
.image-item:hover .item-delete { opacity: 1; }
...
@media (max-width: 640px) {
  .stitch-layout { flex-direction: column; }
  .stitch-right  { width: 100%; }
}
</style>